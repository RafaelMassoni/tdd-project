...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_for_one_user(self): 
        ...
        # Maria decidiu utilizar o novo app TODO. Ela entra em sua p�gina principal:
        self.browser.get(self.live_server_url)

        # Ela nota que o t�tulo da p�gina menciona TODO
        self.assertIn('To-Do', self.browser.title)
        header_text = self.browser.find_element_by_tag_name('h1').text  
        self.assertIn('To-Do', header_text)

        # Ela � convidada a entrar com um item TODO imediatamente
        inputbox = self.browser.find_element_by_id('id_new_item')  
        ...
        # Maria se pergunta se o site vai lembrar da sua lista. Ent�o, ela verifica que
        # o site gerou uma URL �nica para ela -- existe uma explica��o sobre essa feature

        # Ela visita a URL: a sua lista TODO ainda est� armazenada
